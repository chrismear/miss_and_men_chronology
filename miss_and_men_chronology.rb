...
books.push Book.new('Mr. Adventure')
books.push Book.new('Mr. Bounce')
books.push Book.new(
  'Mr. Brave',
  appearances: {
...
books.push Book.new('Mr. Busy')
books.push Book.new('Mr. Calm')
books.push Book.new(
  'Mr. Chatterbox',
  changes: {
...
books.push Book.new('Mr. Cheeky')
books.push Book.new('Mr. Cheerful')
books.push Book.new(
  'Mr. Clever',
  appearances: {
    Character['Mr Clever'] =>
...
books.push Book.new('Mr. Clumsy')
books.push Book.new('Mr. Cool')
books.push Book.new('Mr. Daydream')
books.push Book.new(
  'Mr. Dizzy',
  changes: {
    Character['Mr Dizzy'] =>
...
books.push Book.new('Mr. Impossible')
books.push Book.new(
  'Mr. Jelly',
  changes: {
    Character['Mr Jelly'] => Attribute[:bravery].changes(from: :timid, to: :brave)
  }
)
books.push Book.new(
  'Mr. Lazy'
)
books.push Book.new('Mr. Marvellous')
books.push Book.new('Mr. Mean')
books.push Book.new(
  'Mr. Messy',
  changes: {
    Character['Mr Messy'] =>
...
books.push Book.new('Mr. Mischief')
books.push Book.new('Mr. Muddle')
books.push Book.new('Mr. Nobody')
books.push Book.new('Mr. Noisy', changes: { Character['Mr Noisy'] => Attribute[:loudness].changes(from: :loud, to: :quiet) })
books.push Book.new('Mr. Nonsense')
books.push Book.new(
  'Mr. Nosey',
  changes: {
    Character['Mr Nosey'] =>
...
books.push Book.new('Mr. Perfect')
books.push Book.new('Mr. Quiet')
books.push Book.new('Mr. Rude')
books.push Book.new('Mr. Rush')
books.push Book.new('Mr. Silly')
books.push Book.new(
  'Mr. Skinny',
  changes: {
    Character['Mr Skinny'] =>
...
books.push Book.new('Mr. Slow')
books.push Book.new('Mr. Small')
books.push Book.new(
  'Mr. Sneeze',
...
books.push Book.new('Mr. Strong')
books.push Book.new(
  'Mr. Tall',
  changes: { Character['Mr Tall'] => Attribute[:happiness].changes(from: :miserable, to: :happy) }
)
books.push Book.new(
  'Mr. Tickle',
  appearances: {
...
books.push Book.new(
  'Mr. Uppity',
  changes: { Character['Mr Uppity'] => Attribute[:haughtiness].changes(from: :uppity, to: :polite) }
)
books.push Book.new(
  'Mr. Worry',
  appearances: {
